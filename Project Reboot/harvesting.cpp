...
void Harvest(UObject* Controller, UObject* BuildingActor, float Damage)
{
	...
	static auto ClientReportDamagedResourceBuilding = FindObject<UFunction>("Function /Script/FortniteGame.FortPlayerController.ClientReportDamagedResourceBuilding");
...
bool Harvesting::OnDamageServer(UObject* BuildingActor, UFunction* Function, void* Parameters)
{
	...
	static auto CarDefault_OnDamageServer_Function = FindObject("Function /Game/Building/ActorBlueprints/Prop/Car_DEFAULT.Car_DEFAULT_C.OnDamageServer");
	static auto CarCopper_OnDamageServer_Function = FindObject("Function /Game/Building/ActorBlueprints/Prop/Car_Copper.Car_Copper_C.OnDamageServer");
	static auto BuildingActor_OnDamageServerFunction = FindObject("Function /Script/FortniteGame.BuildingActor.OnDamageServer");
	...
	if (BuildingActor->IsA(BuildingSMActorClass))
	{
		...
		static auto MeleeClass = Fortnite_Version < 10.00 ? FindObject("BlueprintGeneratedClass /Game/Weapons/FORT_Melee/Blueprints/B_Melee_Generic.B_Melee_Generic_C") :
		...
		static auto FortWeaponPickaxeAthenaClass = FindObject("Class /Script/FortniteGame.FortWeaponPickaxeAthena");
